...
namespace _21_OOP_Hamburgerci
{
    public partial class frmSiparisOlustur : Form
    {
        ...
        private void frmSiparisOlustur_Load(object sender, System.EventArgs e)
        {
        ...
        private void btnSiparisEkle_Click(object sender, System.EventArgs e)
        {
        ...
        private void btnSioarisTamamla_Click(object sender, System.EventArgs e)
        {
            DialogResult dr = MessageBox.Show($"Toplam sipariş tutarı: {TutarHesapla().ToString("C2")}, Satınalmayı tamamlamak istermisiniz?", "Sipariş Onay  Bildirimi...,",
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                MessageBox.Show("Siparişiniz Tmamlandı.....");
                Tools.Clean(this.Controls);
            }
        }
    }
